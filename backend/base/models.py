...
class Product(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True) # use ForeignKey to set one-to-many releationship with other models. One user can create/have many products
...
class Review(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True) # One user can have many Reviews
    ...
    def __str__(self):
        # need to convert our rating(int) into string
